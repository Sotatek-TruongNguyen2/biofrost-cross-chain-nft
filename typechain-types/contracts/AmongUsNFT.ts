...
export interface AmongUsNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface AmongUsNFT extends BaseContract {
  connect(runner?: ContractRunner | null): AmongUsNFT;
  waitForDeployment(): Promise<this>;

  interface: AmongUsNFTInterface;
